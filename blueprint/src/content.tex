...
This will elaborate and check the Lean mechanization and print the axioms of our main theorem, \texttt{CompoundProtocol.enforce_compound_consistency}.
...
\texttt{#print axioms CompoundProtocol.enforce_compound_consistency}
...
'CompoundProtocol.enforce_compound_consistency' depends on axioms: [propext, Classical.choice, Quot.sound]

This means that our main theorem, \texttt{CompoundProtocol.enforce_compound_consistency} only depends on the built-in axioms of propositional extensionality, soundness of quotients and the axiom of choice (our proof is classical).
