...
This returns the following message (you can see the message on the right in the infoview panel in VSCode, or if you run it on the command line using
\begin{verbatim}
lake lean CompositionalProtocolProof/CompositionalMCM.lean
\end{verbatim}
it will print it to \texttt{stdout}):
