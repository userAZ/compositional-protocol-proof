...
\begin{definition}[Cache with Perms Has Predecessor That Obtained Perms (Well-Formedness Axiom 7)]
  ...
  This is reflected by the fields in structure `Behaviour.exists_predecessor_setting_state'.
\end{definition}
...
\begin{definition}[Weak Request on Vd Has Successor WB or Get SW (Well-Formedness Axiom 8)]
  ...
  directory event.
  This is reflected by the fields in structure `Behaviour.exists_vd_successor_wb_or_get_sw'.
\end{definition}
...
\begin{definition}[Acquire Invalidation OB Weak Read Predecessor (Well-Formedness Axiom 9)]
  ...
  This is reflected by the parameters in def `CompoundProtocol.acquire_invalidation_OrderedBefore_weak_read_predecessor_that_gets_perms'
\end{definition}
