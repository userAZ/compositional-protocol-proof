...
The Chapter \ref{ch:proof-overview} provides an overview of the structure of the proof
...
\begin{definition}[Cache with Perms Has Predecessor That Obtained Perms (Well-Formedness Axiom 7)]
  ...
  directory for permissions (in field `hexists_pred_getting_perms'). Axiom \ref{requestDirectoryEvent} is used to state the directory request
  matches the preceeding request (field `hpred_accesses_dir').
\end{definition}
