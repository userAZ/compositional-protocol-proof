...
Please look over the theorems and lemmas in the lean mechanization.
In VSCode, theorems and lemmas that are verified by lean have blue checkmarks to
their left. You may check that the theorems and lemmas bear the blue checkmarks.
This docker image should already have the dependencies for VSCode and Lean.

The next Chapter (Chapter \ref{ch:proof-overview}) provides an overview of the structure of the proof
from the paper. You may use it to get an idea of how to navigate parts of the lean
mechanization.
...
To generate a webpage version that includes a graph visualization of the
main theorem, and some of the main lemmas and definitions, run the command:
\begin{verbatim}
  $ leanblueprint web
\end{verbatim}
