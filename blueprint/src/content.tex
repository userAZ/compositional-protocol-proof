...
This document gives an overview of the mechanized proofs, and the blueprint tool synchronizes the definitions and proofs in the mechanization with this document.
...
You can run it by just typing \texttt{/check-artifact.sh}.
This will elaborate and check the Lean mechanization and print the axioms of our main theorem, \texttt{CompoundProtocol.enforce\_compound\_consistency}.
...
This returns the following message (you can see the message on the right in the infoview panel in VSCode, or if you run it on the command line using \texttt{lake lean CompositionalProtocolProof/CompositionalMCM.lean}, it will print it to \texttt{stdout}):

'CompoundProtocol.enforce\_compound\_consistency' depends on axioms: [propext, Classical.choice, Quot.sound]
