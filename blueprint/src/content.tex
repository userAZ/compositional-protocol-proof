...
The next Chapter provides an overview of the structure of the proof
...
We've pre-run the generate pdf and webpage commands.
...
You can optionally re-generate the pdf with the commands:
\begin{verbatim}
  $ leanblueprint pdf
\end{verbatim}
to re-generate the webpage:
\begin{verbatim}
  $ leanblueprint web
\end{verbatim}
