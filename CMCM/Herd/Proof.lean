...
private theorem compose_three {l₁ l₂ l₃ : Event n} {e₁ e₂ e₃ : Event n}
  ...
  | inr hcom_edge =>
    ...
    | obEndLt p₂ hob₂ hlt₂ =>
      ...
      | encapObEndLt q₁ p₁ hq_enc hq_ob hlt₁ =>
        exact Or.inl (.encapObEndLt q₁ p₂ hq_enc (Trans.trans hq_ob (show Event.OrderedBefore n p₁ p₂ from Nat.lt_trans hlt₁ hob₂)) hlt₂)
      | obEndLt p₁ hob₁ hlt₁ =>
        exact Or.inl (.obEndLt p₂ (Trans.trans hob₁ (show Event.OrderedBefore n p₁ p₂ from Nat.lt_trans hlt₁ hob₂)) hlt₂)
      | proxyPair q₁ p₁ hq_enc hq_ob hp_ob =>
    ...
    | encapOb p₂ henc₂ hob₂ =>
      ...
      | obFinishBefore p₁ hob₁ hlt₁ hdiff₁ =>
        ...
        -- Chain: p₁ OB p₂ OB l₃ → p₁ OB l₃. Output .obFinishBefore p₁ (p₁ OB l₃) hlt₁ (l₁ ≠ l₃?).
        have hp₁_ob_p₂ : Event.OrderedBefore n p₁ p₂ := Nat.lt_trans hob₁ henc₂.left
        have hp₁_ob_l₃ : Event.OrderedBefore n p₁ l₃ := Trans.trans hp₁_ob_p₂ hob₂
        by_cases hprot : l₁.protocol = l₃.protocol
        · have h₃_isdir : l₃.isDirectoryEvent := hl₃ ▸ (hknow e₃).hreq's_dir_access.choose_spec.right.isDirEvent
          match hfc₁ : l₁, h₁_isdir with
          | .cacheEvent _, hh => simp [Event.isDirectoryEvent] at hh
    ...
    | proxyPair q₂ p₂ hq_enc₂ hq_ob₂ hp_ob₂ =>
      ...
      | obFinishBefore p₁ hob₁ hlt₁ hdiff₁ =>
        ...
        have hp₁_ob_l₃ : Event.OrderedBefore n p₁ l₃ := Trans.trans hp₁_ob_q₂ (Trans.trans hq_ob₂ hp_ob₂)
        by_cases hprot : l₁.protocol = l₃.protocol
        · have h₃_isdir : l₃.isDirectoryEvent := hl₃ ▸ (hknow e₃).hreq's_dir_access.choose_spec.right.isDirEvent
          match hfc₁ : l₁, h₁_isdir with
          | .cacheEvent _, hh => simp [Event.isDirectoryEvent] at hh
...
/- OLD compose_three body removed.
  ...
  | ob hob₂ =>
    ...
    | obFinishBefore p₁ hob₁_l₂ hlt₁ hdiff₁ =>
      -- p₁ OB l₂, l₂ OB l₃ → p₁ OB l₃. p₁.oEnd < l₁.oEnd.
      exact Or.inl (.obFinishBefore p₁ (Trans.trans hob₁_l₂ hob₂) hlt₁ sorry) -- need l₁.protocol ≠ l₃.protocol
