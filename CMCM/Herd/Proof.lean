      ...
      (temporalRel_of_cle_ob_and_rels (by
        ...
        | .directoryEvent de₁, _ =>
          ...
          | .directoryEvent de₂, _ =>
            ...
            | inr hob_rev =>
              exfalso
              -- de₂.oEnd < de₁.oStart (hob_rev) + de₁.oEnd < p.oStart < p.oEnd < de₂.oEnd → contradiction
      ...
      (temporalRel_of_cle_ob_and_rels (by
        ...
        | .directoryEvent de₁, _ =>
          ...
          | .directoryEvent de₂, _ =>
            ...
            | inr hob_rev =>
              exfalso
              rw [hfc₁] at h_enc; rw [hfc₂] at h_ob
              -- p.oEnd < de₂.oStart ≤ de₂.oEnd < de₁.oStart < p.oStart < p.oEnd
