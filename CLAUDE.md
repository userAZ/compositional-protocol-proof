...
- **THINK before claiming.** Before asserting something is different/hard/impossible, trace through the actual cases. If you don't have enough info, ask. Don't make claims without verification — it wastes hours when the claim turns out to be wrong.
