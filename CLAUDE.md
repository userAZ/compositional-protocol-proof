...
- **Resolve uncertain parts of a plan FIRST.** Before investing in large mechanical work (like a 500-line compose_three duplication), identify which lemmas/theorems have uncertain feasibility and resolve them first. Write the hard helpers, check they compile, THEN do the mechanical work. This avoids discovering blockers after investing hours in the wrong direction.
